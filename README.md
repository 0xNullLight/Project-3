...
#### <em>With endless possibilities of continuation with the application including the following ideas:<em>
...
As a user, who is a developer, I want to be able to pull up a quiz and have it ask me questions I should know for that job interview
...
## Table of Contents
 ...
 - [Video Demonstration](https://github.com/0xNullLight/Project-3/blob/main/README.md#video-demonstration)
...
- A polished UI
- Uses GitHub Actions in the project repository
